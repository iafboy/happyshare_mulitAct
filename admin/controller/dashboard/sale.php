...
class ControllerDashboardSale extends Controller {
	public function index() {
		...
		$today = $this->model_report_sale->getTotalLfxSales(array('filter_date_added' => date('Y-m-d', strtotime('-1 day'))));

		$yesterday = $this->model_report_sale->getTotalLfxSales(array('filter_date_added' => date('Y-m-d', strtotime('-2 day'))));
		...
		$sale_total = $this->model_report_sale->getTotalLfxSales();

              ...
              <div class="row">
                <div class="col-sm-2">
                  <ul class="nav nav-pills nav-stacked" id="address">
                    ...
                    <?php $address_row++; ?>
                    <?php } ?>-->
                    <li id="address"><a href="#tab-address" data-toggle="tab" onclick="javascript:void(0)">收货地址<?php //echo $button_address_add; ?></a></li>
                  </ul>
                </div>
                <div class="col-sm-10">
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab-address">
                        <div class="row">
                          <div class="col-sm-12">
                            <table id="address-list-tb" class="table table-bordered lfx-table place-table" style="margin-top: 10px;">
                              <thead>
                              <tr>
                                <th width="5%"><a onclick="javascript:void(0)">ID</a></th>
                                <th width="5%"><a onclick="javascript:void(0)">收货人</a></th>
                                <th width="20%"><a onclick="javascript:void(0)">联系电话</a></th>
                                <th width="10%"><a onclick="javascript:void(0)">省</a></th>
                                <th width="10%"><a onclick="javascript:void(0)">市</a></th>
                                <th width="10%"><a onclick="javascript:void(0)">区</a></th>
                                <th width="30%"><a onclick="javascript:void(0)">详细地址</a></th>
                              </tr>
                              </thead>
                              <tbody>
                              </tbody>
...
<script>
  $(function () {
    $tb = $('#address-list-tb');
    var url = 'index.php?route=common/api/getCustomerAddressList&token=<?php echo $token; ?>';
    var params = {customerId:'<?php echo $customer_id; ?>'};
    $.model.commonAjax(url,params, function (data) {
      if(data && $.isArray(data) && data.length>0){
        var html = '';
        for(var i = 0;i < data.length;i++){
          var ad = data[i];
          html = html + '<tr data-address-id="'+ad.address_id+'" > \
                  <td>'+ad.address_id+'</td> \
                  <td>'+ad.fullname+'</td> \
          <td>'+ad.phone+'</td> \
          <td>'+ad.province+'</td> \
        ...
        $tb.find('tbody').empty().append(html);
      }
    });

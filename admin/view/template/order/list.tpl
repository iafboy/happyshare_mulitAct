        ...
        <table class="table table-bordered table-hover lfx-table">
          ...
          <tr class="order-item-<?php echo $order['order_id']; ?>">
            ...
            <td class="text-center" class="order-status"><?php echo $order['order_status_text']; ?></td>
              <td class="text-center"><?php echo $order['order_supplier']; ?></td>
            <td class="text-center"><?php echo substr($order['fullname'],0,3).'****'.substr($order['fullname'],7); ?></td>
            <td class="text-center"><?php echo $order['receiver_fullname']; ?></td>
            <td class="text-center"><?php echo substr($order['receiver_phone'],0,3).'****'.substr($order['receiver_phone'],7); ?></td>

        ...
        foreach($entries[$i] as $entry){
            if(is_array($entry) && is_array($entry[0])){
                ...
                foreach($entry as $e){
                    ...
                    <div class="form-group" style="display: inline-block;width: 45%;">
                        ...
                        <select name="<?php echo $e['filter_name']; ?>" class="lfx-select w-10 <?php echo $e['entry']; ?>">
                            <?php
                    ...
                    <?php }else if($e['type']=='date'){ ?>
                        <div class="form-group" style="display: inline-block;width: 45%;">
                            <label class="control-label" style="display: block;" ><?php echo $e['entry_name']; ?></label>
                            <div class="date" style="display: inline-block;">
                                <input style="display: inline-block;width: 70%;" type="text" name="<?php echo $e['filter_name']; ?>"
                                       value="<?php echo $e['filter_value']; ?>"
                                       data-date-format="YYYY-MM-DD" class="lfx-text <?php echo $e['entry']; ?>" />
                        ...
                        <div class="form-group" style="display: inline-block;width: 45%;">
                            ...
                            if($e['filter_value']===true || $e['filter_value']===1 || $e['filter_value'] === '1'){ ?>
                                <input type="<?php echo $e['type'] ?>"
                                       name="<?php echo $e['filter_name']; ?>" checked class="form-control <?php echo $e['entry']; ?>" />
                            <?php }else{ ?>
                                <input type="<?php echo $e['type'] ?>"
                                       name="<?php echo $e['filter_name']; ?>" class="form-control <?php echo $e['entry']; ?>" />
                            <?php }
                             ?>
                        </div>
                    <?php }else{ ?>
                        <div class="form-group" style="display: inline-block;width: 45%;">
                            <label class="control-label" ><?php echo $e['entry_name']; ?></label>
                            <input type="<?php echo $e['type'] ?>"
                                   name="<?php echo $e['filter_name']; ?>" value="<?php echo $e['filter_value']; ?>"
                                   class="lfx-text w-10 <?php echo $e['entry']; ?>" />
                        </div>
                    <?php }
                }?>
            ...
            <?php }else{ ?>
                ...
                <div class="form-group">
                    ...
                    <select name="<?php echo $entry['filter_name']; ?>" class="lfx-select w-10 <?php echo $entry['entry']; ?>">
                        <?php
                        foreach($options as $key=>$value){
                ...
                <div class="form-group">
                    ...
                    <div class="date" style="display: inline-block;">
                        <input style="display: inline-block;width: 70%;" type="text" name="<?php echo $entry['filter_name']; ?>"
                               ...
                               data-date-format="YYYY-MM-DD" class="lfx-text <?php echo $entry['entry']; ?>" />
                        <span class="" style="width: 30%;">
                        <button class="lfx-btn" type="button"><i class="fa fa-calendar"></i></button>
                        </span>
                    </div>
                ...
                <div class="form-group" style="display: inline-block;width: 45%;">
                    <label class="control-label" ><?php echo $entry['entry_name']; ?></label>
                    <?php
                    if($entry['filter_value']===true || $entry['filter_value']===1 || $entry['filter_value'] === '1' || $entry['filter_value'] === 'on'){ ?>
                        <input type="<?php echo $entry['type'] ?>"
                               name="<?php echo $entry['filter_name']; ?>" checked class="form-control <?php echo $entry['entry']; ?>" />
                    <?php }else{ ?>
                        <input type="<?php echo $entry['type'] ?>"
                               name="<?php echo $entry['filter_name']; ?>" class="form-control <?php echo $entry['entry']; ?>" />
                    <?php }
                     ?>
                </div>
                <?php }else{ ?>
                <div class="form-group">
                    ...
                    <input type="<?php echo $entry['type'] ?>" placeholder="<?php echo $entry['entry_name']; ?>"
                           ...
                           value="<?php echo $entry['filter_value']; ?>" class="lfx-text w-10 <?php echo $entry['entry']; ?>" />
                </div>
                <?php } ?>

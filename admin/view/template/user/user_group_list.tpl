      ...
      <div class="table-responsive">
        <table class="table table-bordered table-hover lfx-table">
          ...
          <tr>
            ...
            <td class="text-right"><a href="<?php echo $user_group['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-default btn-sm lfx-btn"><i class="fa fa-pencil"></i></a></td>
          </tr>
          <?php } ?>
          <?php } else { ?>
          <tr>

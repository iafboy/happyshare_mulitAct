          ...
          <div class="well well-sm" style=" overflow: auto;">
            <?php foreach ($permissions as $permission) { ?>
              ...
              <div class="checkbox">
                ...
                <?php }else{ ?>
                  <input type="hidden" name="permission[access][]" value="<?php echo $permission; ?>" />
                <?php }
                ?>
            <?php } ?>
          </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <div class="well well-sm" style=" overflow: auto;">
              ...
              <?php }else{ ?>
              <input type="hidden" name="permission[modify][]" value="<?php echo $permission; ?>" />
              <?php }
                ?>
              <?php } ?>
          </div>

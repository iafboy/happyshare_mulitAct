...
class ModelSaleOrder extends Model {
	...
	public function getOrders($data = array()) {
		...
		if (isset($data['filter_order_status'])) {
			...
			foreach ($order_statuses as $order_status_id) {
				$implode[] = "o.order_status = '" . (int)$order_status_id . "'";
			}
			...
			$sql .= " WHERE o.order_status in( '0','2','3','4','10','11','12')";
		}
	...
	public function getSupplierOrders($data = array(),$supplierid) {
		$sql = "SELECT o.order_id,o.order_no as order_no, o.fullname AS customer, (SELECT os.name FROM " . DB_PREFIX . "order_status os WHERE os.order_status_id = o.order_status AND os.language_id = '" . (int)$this->config->get('config_language_id') . "') AS status, o.shipping_code, o.total, o.currency_code, o.currency_value, o.date_added, o.date_modified FROM `" . DB_PREFIX . "order` o,`".DB_PREFIX."order_product` q where o.order_id=q.order_id and q.supplier_id='".$supplierid."'";
		...
		if (isset($data['filter_order_status'])) {
			...
			foreach ($order_statuses as $order_status_id) {
				$implode[] = "and o.order_status = '" . (int)$order_status_id . "'";
			}
			...
			$sql .= " and o.order_status in( '0','2','3','4','10','11','12')";
		}
	...
	public function getTotalOrdersNew($supplier_id) {
    $sql = "SELECT COUNT(*) AS total FROM `" . DB_PREFIX . "order`";
    
    $sql .= " WHERE supplier_id='" . (int)$supplier_id . "'";
    //$sql .= " WHERE supplier_id='3'";
	...
	public function getTotalOrders($data = array()) {
		...
		if (!empty($data['filter_order_status'])) {
			...
			foreach ($order_statuses as $order_status_id) {
				$implode[] = "order_status = '" . (int)$order_status_id . "'";
			}
			...
			$sql .= " WHERE order_status in( '0','2','3','4','10','11','12')";
		}
	...
	public function getTotalSupplierOrders($data = array()) {
		$sql = "SELECT COUNT(*) AS total FROM `" . DB_PREFIX . "order` p,`".DB_PREFIX."order_product` o where p.order_id=o.order_id and o.supplier_id='".$data['filter_supplier_id']."'";
		...
		if (!empty($data['filter_order_status'])) {
			...
			$sql .= " and p.order_status in( '0','2','3','4','10','11','12')";
		}
	...
	public function getAllSupplierOrders($supplierid) {
		$sql = "SELECT COUNT(*) AS total FROM `" . DB_PREFIX . "order` p,`".DB_PREFIX."order_product` o where p.order_id=o.order_id and o.supplier_id='".$supplierid."'";
		$sql .= " and p.order_status in( '0','2','3','4','10','11','12')";
		$query = $this->db->query($sql);

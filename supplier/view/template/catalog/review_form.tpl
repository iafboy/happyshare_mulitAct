      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-review" class="form-horizontal">
          ...
          <div class="form-group col-sm-10">
            <label class="col-sm-2 control-label" for="input-product"><a><?php echo "商品名称"; ?></a></label>
            <div class="col-sm-10">
              <input disabled="disabled" type="text" name="product" value="<?php echo $product; ?>" placeholder="<?php echo $entry_product; ?>" id="input-product" class="form-control" />
          ...
          <div class="form-group required col-sm-10">
            <label class="col-sm-2 control-label" for="input-text"><a><?php echo $entry_text; ?></a></label>
            <div class="col-sm-10">
              <textarea name="text" cols="60" rows="8" placeholder="<?php echo $text_form; ?>" id="input-text" class="form-control"><?php echo ""; ?></textarea>
              <?php if ($error_text) { ?>

        ...
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-4">
              ...
              <div class="form-group">
                <label class="control-label" for="input-key-word"><?php echo "报告内容关键字"; ?></label>
                <div>
                  <div class="col-sm-8" style="display:inline;padding-left: 0;">
                  <input type="text" name="filter_key_word" value="<?php echo $filter_key_word; ?>" placeholder="<?php echo "报告内容关键字"; ?>" id="input-key-word" class="form-control" />
                  </div>
            ...
            <div class="col-sm-4">
              ...
              <div class="form-group col-sm-6">
                ...
                <select name="filter_status" id="input-status" class="form-control">
                  ...
                  <option value="0" selected="selected"><?php echo $text_enabled_csr; ?></option>
                  <option value="1"><?php echo $text_disabled_csr; ?></option>
                  <?php } else if ($filter_status == "1") { ?>
                  <option value="0"><?php echo $text_enabled_csr; ?></option>
                  <option value="1" selected="selected"><?php echo $text_disabled_csr; ?></option>
                  <?php } else { ?>
                  <option value="0"><?php echo $text_enabled_csr; ?></option>
                  <option value="1"><?php echo $text_disabled_csr; ?></option>
                  <?php } ?>
              ...
              <div>
                <label class="control-label" ><?php echo "报告发布日期"; ?></label>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                ...
                <!--
                  ...
                  <td class="text-center"><?php if ($sort == 'p.product_id') { ?>
                    <a href="<?php echo $sort_pid; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_product_id; ?></a>
                    <?php } else { ?>
              ...
              <tbody>
                ...
                <!--
                  ...
                  -->
                  <td class="text-center"><?php echo $review['pid']; ?></td>
                  <td class="text-center"><?php echo $review['name']; ?></td>
                  <td class="text-center"><?php echo $review['cname']; ?></td>
                  <td class="text-center"><?php echo $review['date_added']; ?></td>
                  <td class="text-center"><?php echo $review['status']; ?></td>
                  <td class="text-center"><?php echo $review['content']; ?></td>
                  <td class="text-center">
                    <!--
                    <a href="<?php echo $review['enable']; ?>" data-toggle="tooltip" title="<?php echo $button_review_enable; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i><?php echo $button_review_enable; ?></a>
                    <a href="<?php echo $review['disable']; ?>" data-toggle="tooltip" title="<?php echo $button_review_disable; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i><?php echo $button_review_disable; ?></a>
                    <a href="<?php echo $review['abort']; ?>" data-toggle="tooltip" title="<?php echo $button_review_abort; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i><?php echo $button_review_abort; ?></a>
                    -->
                    <a href="<?php echo $review['action']; ?>" data-toggle="tooltip" title="<?php echo $review['action_title']; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i><?php echo $review['action_title']; ?></a>
                  </td>
                </tr>
                <?php } ?>
                <?php } else { ?>
...
$('body').delegate('#button-filter','click', function() {
	url = 'index.php?route=catalog/review_csr&token=<?php echo $token; ?>';

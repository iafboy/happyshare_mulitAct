        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
              ...
              <!-- "special for leshare project : when reseting the password, the user must enter auth code from SMS he/she got " -->
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-auth-code"><?php echo $entry_authcode; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="authcode" value="<?php echo $authcode; ?>" id="input-auth-code" class="form-control" />
                  <?php if ($error_authcode) { ?>
                  <div class="text-danger"><?php echo $error_authcode; ?></div>
                  <?php } ?>
                </div>
              </div>

...
<link type="text/css" href="view/stylesheet/leshare.css" rel="stylesheet"  />
...
<script src="view/javascript/dialog.js"></script>
  ...
  <script src="view/javascript/admin.js" type="text/javascript"></script>
  <script src="view/javascript/tools.js" type="text/javascript"></script>
  ...
  <ul class="nav pull-right">
   ...
   <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-life-ring fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right">
        ...
        <li><a href="http://forum.mycncart.com" target="_blank"><?php echo $text_support; ?></a></li>
      </ul>
    </li>
	-->
    <!-- 登陆用户信息提示 -->

<ul id="menu">
  ...
  <!-- "Settlement Report" -->
  <li id="settlement">
    <a class="parent"><i class="fa fa-bar-chart fa-fw"></i> <span><?php echo $text_settlement; ?></span></a>
    <ul>
    <li><a href="<?php echo $report_list; ?>"><?php echo $text_settlement; ?></a></li>
    </ul>
  </li>
  
  <!-- "Product Management" -->
  <li id="product">
    <a class="parent"><i class="fa fa-cubes fa-fw"></i> <span><?php echo $text_management; ?></span></a>
    <ul>
      <!--
      <li><a href="<?php echo $product_edit; ?>"><?php echo $text_product_edit."(old)"; ?></a></li>
      -->
      <li><a href="<?php echo $product; ?>"><?php echo $text_management; ?></a></li>
      <li><a href="<?php echo $product_add; ?>">商品发布/编辑</a></li>
    </ul>
  </li>
  ...
  <!--
  <li id="brand">
    <a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_brand_pavilion; ?></span></a>
    <ul>
    <li><a href="<?php echo $brand_pavilion; ?>"><?php echo $text_brand_pavilion; ?></a></li>
    </ul>
  </li>
	-->
  <!-- "Logistics Settings" -->
  <li id="logistics">
    <a class="parent" ><i class="fa fa-gear fa-fw"></i> <span><?php echo $text_logistics; ?></span></a>
    <ul>
    <li><a href="<?php echo $express_config; ?>"><?php echo $text_logistics; ?></a></li>
    </ul>
  </li>

  <!-- "Comments Management" -->
  <li id="Comments">
    <a class="parent"><i class="fa fa-comments fa-fw"></i> <span><?php echo $text_comments; ?></span></a>
    <ul>
      <li><a href="<?php echo $review; ?>"><?php echo $text_comments; ?></a></li>
      <!--
      <li><a href="<?php echo $review_csr; ?>"><?php echo $text_review_csr; ?></a></li>
      -->
    </ul>
 </li>
  ...
  <!-- "User Management" -->
  <li id="user">
    <a class="parent" ><i class="fa fa-users fa-fw"></i> <span><?php echo $text_user_mngt; ?></span></a>
      <ul>
        <li><a href="<?php echo $user; ?>"><?php echo $text_user_mngt; ?></a></li>
...
<!--        
  ...
  <!-- annotated by liuhang, for suppliers, we don't need this operation option -->
  <!--
  <li id="catalog">
  ...
  <!-- Reserve For Future-->
  <!--
  <li id="others"><a class="parent_new"><i class="fa fa-key fa-fw"></i> <span><?php echo $text_others; ?></span></a>
  </li>
  -->
</ul>

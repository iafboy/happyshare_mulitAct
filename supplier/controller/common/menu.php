...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_review_csr'] = $this->language->get('text_review_csr');
   	...
   	$data['text_settlement'] = $this->language->get('text_settlement');
		$data['text_management'] = $this->language->get('text_management');
		$data['text_product_edit'] = $this->language->get('text_product_edit');
		$data['text_logistics'] = $this->language->get('text_logistics');
		$data['text_comments'] = $this->language->get('text_comments');
		$data['text_order_info'] = $this->language->get('text_order_info');
		$data['text_user_mngt'] = $this->language->get('text_user_mngt');
		$data['text_brand_pavilion'] = $this->language->get('text_brand_pavilion');
   	...
   	$data['supplier_list'] = $this->url->link('supplier/list', 'token=' . $this->session->data['token'], 'SSL');
    	...
    	/*liuhang add for 'orders' detailed info' page*/
//    	$data['order_details'] = $this->url->link('sale/order/info', 'token=' . $this->session->data['token'], 'SSL');


		$data['express_config'] = $this->url->link('express/config', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['product_edit'] = $this->url->link('catalog/product/add', 'token=' . $this->session->data['token'], 'SSL');
		$data['product_add'] = $this->url->link('product/add', 'token=' . $this->session->data['token'], 'SSL');
    /***** liuhang add ***/
    $data['product_edit_new'] = $this->url->link('catalog/product/add_new', 'token=' . $this->session->data['token'], 'SSL');
    $data['brand_pavilion'] = $this->url->link('brand/add', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['review_csr'] = $this->url->link('catalog/review_csr', 'token=' . $this->session->data['token'], 'SSL');

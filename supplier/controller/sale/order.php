...
class ControllerSaleOrder extends Controller {
	...
	protected function getList() {
		...
		if (isset($this->request->get['filter_recipent'])) {
			$filter_recipent = $this->request->get['filter_recipent'];
		} else {
			$filter_recipent = NULL;
    	}
		if (isset($this->request->get['filter_recipent_phone'])) {
			$filter_recipent_phone = $this->request->get['filter_recipent_phone'];
		} else {
			$filter_recipent_phone = NULL;
    	}
		...
		if (isset($this->request->get['filter_recipent'])) {
			$url .= '&filter_recipent=' . $this->request->get['filter_recipent'];
		}

		if (isset($this->request->get['filter_recipent_phone'])) {
			$url .= '&filter_recipent_phone=' . $this->request->get['filter_recipent_phone'];
		}
		...
		$filter_data = array(
			...
			'filter_recipent'      => $filter_recipent,
			'filter_recipent_phone'=> $filter_recipent_phone,
    ...
    $supplier_id = $this->session->data['supplier_id'];
		$order_total = $this->model_sale_order->getTotalOrdersNew($supplier_id);
		...
		$data['column_recipient_phone'] = $this->language->get('column_recipient_phone');
		...
		$data['column_order_info'] = $this->language->get('column_order_info');
		...
		$data['text_recipient_phone'] = $this->language->get('text_recipient_phone');
    ...
    $data['page_limit'] = $this->config->get('config_limit_admin');
		...
		$data['filter_recipient'] = $filter_recipent;
		$data['filter_recipient_phone'] = $filter_recipent_phone;
  ...
  public function info() {
    ...
    'order_desc' => ''
		...
		$data['heading_title'] = $this->language->get('heading_title');
		$data['token'] = $this->session->data['token'];
		$data['supplier_id'] = $this->session->data['supplier_id'];

...
// HTTP
define('HTTP_SERVER', 'http://'.LOCAL_IP.'/leshare/supplier/');
define('HTTP_CATALOG', 'http://'.LOCAL_IP.'/leshare/');

// HTTPS
define('HTTPS_SERVER', 'https://'.LOCAL_IP.'/leshare/supplier/');
define('HTTPS_CATALOG', 'https://'.LOCAL_IP.'/leshare/');

// DIR
define('DIR_APPLICATION',     ROOT_PATH.'supplier/');
define('DIR_SYSTEM',          ROOT_PATH.'system/');
define('DIR_WAP',             ROOT_PATH.'wap/');
define('DIR_LANGUAGE',        ROOT_PATH.'supplier/language/');
define('DIR_TEMPLATE',        ROOT_PATH.'supplier/view/template/');
